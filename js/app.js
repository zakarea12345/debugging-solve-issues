// load product by click on search btn 
const loadProducts = () => {
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <h5 class="ratings card-text">Average Rating: ${product.rating.rate}</h5>
      <h5 class="ratings card-text">Number of people who give ratings: ${product.rating.count}</h5>
...
// get input value by click on add to cart btn 
...
// call the load product function 
loadProducts();
